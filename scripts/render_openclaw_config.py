...
def build_defaults() -> dict[str, str]:
    ...
    defaults: dict[str, str] = {
        ...
        "OLLAMA_MODEL_NAME": os.environ.get("OLLAMA_MODEL_NAME", "Llama 3.2"),
        "OLLAMA_CONTEXT_WINDOW": os.environ.get("OLLAMA_CONTEXT_WINDOW", "8192"),
        "OLLAMA_MAX_TOKENS": os.environ.get("OLLAMA_MAX_TOKENS", "4096"),
